...
try{
 ...
 for(const tier of list){
  ...
  await page.goto(`${url}/?quality=${tier}&role=raider&practice=1`); await page.waitForFunction(() => window.COLOSSUS_ART_READY === true); await page.waitForFunction(() => window.__COLOSSUS.state !== null);
