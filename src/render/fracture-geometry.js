...
import {skinKey} from '../world/buildings.js';
...
function bounds(piece,group){return {lo:piece.p.map((v,k)=>piece.grid[k]===0?-Infinity:v-piece.size[k]/2),hi:piece.p.map((v,k)=>piece.grid[k]===group.n[k]-1?Infinity:v+piece.size[k]/2)};}
