...
const color={stone:0xd2c9b8,concrete:0xbbbcb5,glass:0x668996,blueGlass:0x8da9b7,silver:0xc5cac9,slate:0x29363d,jade:0x538a79,steel:0x465059,crownGlass:0x162f3e,darkBronze:0x514436,marble:0xeeeae0,terracotta:0xc9bfac,bronze:0x8c7047};
export const catalogTint=id=>WORLD_STYLE_BY_ID.get(id)?.tint??({park432:0xe4e1d8,woolworth:0xd2c9b8,wall40:0xbcb7a7,rockefeller30:0xd0c6af,seagram:0x554c3c,'lever-house':0x62938a,citigroup:0x9dabb2,hearst:0x6e939c}[id]);
...
function landmarkGeometry(style){
 ...
 for(const c of cells){
  ...
  worldPlacements(c,(type,side=-1)=>{if(CATALOG_COMPONENTS[type].signature)add(type,c,side);});
