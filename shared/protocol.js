// 32-byte header + 68-byte boss + players(64 each) + moving bodies(32 each).
// Float32 positions/quaternions, not JSON transforms. Little-endian, versioned (COL3).
export const MAGIC = 0x434f4c33;
export const HEADER = 100, PLAYER = 64, BODY = 32, MAX_PLAYERS = 9, MAX_BODIES = 1200;
