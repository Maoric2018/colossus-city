// 32-byte header + 108-byte boss + players(64 each) + moving bodies(32 each).
// Float32 positions/quaternions, not JSON transforms. Little-endian, versioned (COL6).
import {handQuaternion} from './giant-rig.js';
import {C} from './config.js';
export const MAGIC = 0x434f4c36;
export const HEADER = 140, PLAYER = 64, BODY = 32, MAX_PLAYERS = 9, MAX_BODIES = 1200;
