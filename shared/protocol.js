// 32-byte header + 100-byte boss + players(64 each) + moving bodies(32 each).
// Float32 positions/quaternions, not JSON transforms. Little-endian, versioned (COL4).
import {handQuaternion} from './giant-rig.js';
export const MAGIC = 0x434f4c34;
export const HEADER = 132, PLAYER = 64, BODY = 32, MAX_PLAYERS = 9, MAX_BODIES = 1200;
