...
Distant landmarks reuse one instanced silhouette per design. Their identifying facade strips and crowns remain visible beyond close-detail range. Damaged world landmarks render surviving shaped bays at distance, preserving portals and removed pieces. Glass towers share an opaque curtain-wall material with per-instance tint; this avoids internal surfaces showing through and reduces transparent overdraw. Streamed districts reuse that material and its textures. Close-detail loading remains capped at nine blocks, with existing Quest fog and detail-distance limits.
