...
The current pass has 176 passing automated tests. In the four material browser fixtures, fewer than 0.001% of image pixels differed when the broken pieces were reassembled in their original positions. Browser flight and Quest 2 stereo emulation also pass. Physical Quest 2 testing is still needed to establish headset frame rate under extended destruction.
