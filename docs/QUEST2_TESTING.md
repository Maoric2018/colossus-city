...
- Repeat rapid punches in the same bay, then collapse several adjacent bays. Check original textures on every broken face, persistent rubble, reopened support holes and recovery after leaving and returning. The client now keeps up to 49 detailed blocks with 110–150 m Quest fog; watch for loading pauses and roof props floating beyond their supporting building. Spectator capture may reduce its own cadence/resolution under pressure; the player's destruction detail should remain intact.
