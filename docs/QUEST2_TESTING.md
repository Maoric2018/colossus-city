...
- 58 automated Node tests, including real server physics and multiplayer.
...
- Eight-player server collapse benchmark: maximum 6.81 ms per simulation step on this Mac, within the 16.67 ms budget.
...
- Fire each controller’s missiles at buildings and raiders; check cooldown, explosions and damage.
