...
Generic buildings use window surrounds that match their facade textures, one main entrance, appropriate balconies and a rear fire escape on brick walkups. Rooftop services occupy one small area per building; repeated machinery, random satellite dishes, window grilles and overlapping decorative frames are removed. Interior structure remains visible after destruction, and landmarks retain their custom architectural kits. Downloaded photographic textures and compatible roof models are reused. Up to 81 detailed generated blocks surround the camera, with no simplified distant building ring. Distance fog fades from 128–240 m on Quest and 160–260 m on desktop.
