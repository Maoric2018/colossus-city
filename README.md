...
Buildings keep a connected support graph, but gameplay impacts break **individual panes, bricks, stone/concrete tiles, short steel sections and slab fragments**. Fine pieces are generated only when a bay is touched. Typical maximum sizes are 0.42 × 0.24 m for brick faces, 0.76 × 0.82 m for glass panes, and 0.62 m for steel lengths. Original facade textures remain aligned on surviving pieces. Authored landmark silhouettes stay intact until their parts are struck.
