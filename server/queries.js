...
export function lazySceneQueries(world){
 ...
 for(const name of ['createRigidBody','createCollider','removeRigidBody','removeCollider']){const change=world[name].bind(world);world[name]=(...args)=>{dirty=true;return change(...args);};}
